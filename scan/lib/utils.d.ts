...
export declare function prepareAgent(args: string[], nightlyVersion?: string, useInstalledCli?: boolean): Promise<void>;
/**
 ...
 */
export declare function putReaction(githubToken: string, newReaction: Reaction, oldReaction: string): Promise<void>;
/**
