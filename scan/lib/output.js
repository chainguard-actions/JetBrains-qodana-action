...
function publishOutput(failedByThreshold, projectDir, sourceDir, resultsDir, useAnnotations, postComment, isPrMode, execute) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const sanityProblemsCount = (0, qodana_1.getSanityProblemsCount)(`${resultsDir}/${qodana_1.QODANA_SARIF_NAME}`);
            ...
            problems.summary = (0, output_1.getSummary)(toolName, projectDir, sourceDir, problemsDescriptions, coverageInfo, licensesInfo.packages, licensesInfo.licenses, reportUrl, isPrMode, exports.DEPENDENCY_CHARS_LIMIT, exports.VIEW_REPORT_OPTIONS, sanityProblemsCount);
            // source dir is needed for project distinction in monorepo
            const jobName = `${toolName}` + (sourceDir === '' ? '' : ` (${sourceDir})`);
            yield Promise.all([
                (0, utils_1.putReaction)((0, utils_1.getInputs)().githubToken, utils_1.ANALYSIS_FINISHED_REACTION, utils_1.ANALYSIS_STARTED_REACTION),
